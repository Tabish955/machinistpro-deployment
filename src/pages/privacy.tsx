...
export default function PrivacyPage() {
  return (
    <InfoPage title="Privacy Policy">
      ...
      <p>
        MachinistPro (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) respects your privacy. This Privacy Policy explains how we collect, use, and protect your information when you use our application.
      </p>
      ...
      <p>MachinistPro uses an offline-first architecture. Your engineering data — calculations, projects, notes, and preferences — is stored exclusively on your device. We do not transmit, store, or have access to your calculation data.</p>
      ...
      <p>MachinistPro uses browser local storage (not cookies) for application data. Google Analytics may set cookies for analytics purposes.</p>

      <h2 className="text-lg font-semibold text-white pt-2">6. Data Security</h2>
      <p>We implement reasonable security measures including encrypted authentication, server-side credential handling, and no client-side exposure of sensitive data. Your local data is protected by your browser&apos;s built-in security mechanisms.</p>

      <h2 className="text-lg font-semibold text-white pt-2">7. Your Rights</h2>
      <p>You can export or delete all your local data at any time through Settings → Export Backup or Settings → Clear Local Data. Since we don&apos;t store your engineering data, there is no server-side data to delete.</p>

...
function f(id: string, label: string, placeholder = ""): { id: string; label: string; placeholder: string; unit: "length" } {
...
export const SHAPES: ShapeDef[] = [
  // ══════════════════════════ SOLID ══════════════════════════════════════════
  {
    id: "round_bar", name: "Round Bar", group: "solid",
    fields: [f("d", "Diameter", "e.g. 50"), f("l", "Length", "e.g. 1000")],
    volume: ({ d, l }) => PI / 4 * d * d * l,
    formula: "V = π/4 × D² × L",
  },
  {
    id: "square_bar", name: "Square Bar", group: "solid",
  ...
  },
  {
    ...
    fields: [f("w", "Width", "e.g. 100"), f("t", "Thickness", "e.g. 10"), f("l", "Length", "e.g. 1000")],
    volume: ({ w, t, l }) => w * t * l,
    formula: "V = W × T × L",
  },
  {
    id: "plate", name: "Plate", group: "solid",
    fields: [f("w", "Width", "e.g. 1200"), f("h", "Height", "e.g. 2400"), f("t", "Thickness", "e.g. 6")],
    volume: ({ w, h, t }) => w * h * t,
    formula: "V = W × H × T",
  },
  {
    id: "block", name: "Block", group: "solid",
    fields: [f("w", "Width", "e.g. 100"), f("h", "Height", "e.g. 50"), f("l", "Length", "e.g. 200")],
    volume: ({ w, h, l }) => w * h * l,
    formula: "V = W × H × L",
  },
  {
    id: "cylinder", name: "Cylinder", group: "solid",
    fields: [f("d", "Diameter", "e.g. 80"), f("h", "Height", "e.g. 100")],
    volume: ({ d, h }) => PI / 4 * d * d * h,
    formula: "V = π/4 × D² × H",
  },
  {
    id: "sphere", name: "Sphere", group: "solid",
  ...
  // ══════════════════════════ HOLLOW ═════════════════════════════════════════
  {
    id: "pipe", name: "Pipe / Tube (Round)", group: "hollow",
    fields: [f("od", "Outside Diameter", "e.g. 50"), f("id", "Inside Diameter", "e.g. 40"), f("l", "Length", "e.g. 1000")],
  ...
  // ══════════════════════════ STRUCTURAL ═════════════════════════════════════
  {
    id: "angle", name: "Angle (L-section)", group: "structural",
    fields: [f("a", "Leg A", "e.g. 50"), f("b", "Leg B", "e.g. 50"), f("t", "Thickness", "e.g. 5"), f("l", "Length", "e.g. 1000")],
    volume: ({ a, b, t, l }) => (a * t + (b - t) * t) * l,
    formula: "V = (A×t + (B−t)×t) × L",
  },
  {
    id: "channel", name: "Channel (C-section)", group: "structural",
    fields: [f("h", "Height", "e.g. 100"), f("w", "Flange Width", "e.g. 50"), f("tw", "Web Thick", "e.g. 5"), f("tf", "Flange Thick", "e.g. 7"), f("l", "Length", "e.g. 1000")],
    volume: ({ h, w, tw, tf, l }) => ((h - 2 * tf) * tw + 2 * w * tf) * l,
    formula: "V = ((H−2tf)×tw + 2×W×tf) × L",
  },
  {
    id: "i_beam", name: "I-Beam / H-Beam", group: "structural",
    fields: [f("h", "Height", "e.g. 200"), f("w", "Flange Width", "e.g. 100"), f("tw", "Web Thick", "e.g. 6"), f("tf", "Flange Thick", "e.g. 10"), f("l", "Length", "e.g. 1000")],
    volume: ({ h, w, tw, tf, l }) => ((h - 2 * tf) * tw + 2 * w * tf) * l,
    formula: "V = ((H−2tf)×tw + 2×W×tf) × L",
  },
  {
    id: "t_section", name: "T-Section", group: "structural",
    fields: [f("w", "Flange Width", "e.g. 100"), f("h", "Total Height", "e.g. 80"), f("tf", "Flange Thick", "e.g. 8"), f("tw", "Web Thick", "e.g. 6"), f("l", "Length", "e.g. 1000")],
  ...
  // ══════════════════════════ SHEET ══════════════════════════════════════════
  {
    id: "sheet", name: "Sheet / Coil / Strip", group: "sheet",
    fields: [f("w", "Width", "e.g. 1200"), f("l", "Length", "e.g. 2400"), f("t", "Thickness", "e.g. 2")],
    volume: ({ w, l, t }) => w * l * t,
    formula: "V = W × L × T",
  },
];

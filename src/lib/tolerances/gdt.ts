...
export const GDT_SYMBOLS: GDTSymbol[] = [
  ...
  },
  {
    ...
    category: "location",
    meaning:
      "Median points of a feature must lie within a cylindrical tolerance zone centered on a datum axis.",
  ...
  // Runout
  {
    ...
    category: "runout",
    meaning:
      "Each circular element must not vary more than the tolerance when rotated about a datum axis.",

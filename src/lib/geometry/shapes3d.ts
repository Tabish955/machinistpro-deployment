...
export const SHAPES_3D: Shape3D[] = [
  {
    ...
    calc: ({ a }) => [r("Volume", a ** 3), r("Surface Area", 6 * a * a, "u²"), r("Diagonal", a * Math.sqrt(3), "u")],
    formula: "V = a³ · SA = 6a²",
  ...
  {
    id: "cuboid", name: "Cuboid / Box",
    fields: [f("l", "Length"), f("w", "Width"), f("h", "Height")],
    calc: ({ l, w, h }) => [r("Volume", l * w * h), r("Surface Area", 2 * (l * w + w * h + h * l), "u²"), r("Space Diagonal", Math.sqrt(l ** 2 + w ** 2 + h ** 2), "u")],
    formula: "V = l×w×h · SA = 2(lw+wh+hl)",
  },
  {
    id: "sphere", name: "Sphere",
    fields: [f("r", "Radius")],
    calc: ({ r: rad }) => [r("Volume", (4 / 3) * PI * rad ** 3), r("Surface Area", 4 * PI * rad * rad, "u²")],
  ...
  },
  {
    ...
    fields: [f("r", "Radius")],
    calc: ({ r: rad }) => [r("Volume", (2 / 3) * PI * rad ** 3), r("Curved SA", 2 * PI * rad * rad, "u²"), r("Total SA", 3 * PI * rad * rad, "u²")],
    formula: "V = (2/3)πr³ · CSA = 2πr² · TSA = 3πr²",
  },
  {
    id: "cylinder", name: "Cylinder",
    fields: [f("r", "Radius"), f("h", "Height")],
    calc: ({ r: rad, h }) => [r("Volume", PI * rad * rad * h), r("Lateral SA", 2 * PI * rad * h, "u²"), r("Total SA", 2 * PI * rad * (rad + h), "u²")],
  ...
  },
  {
    ...
    calc: ({ r: rad, h }) => {
      ...
      return [r("Volume", (PI * rad * rad * h) / 3), r("Slant Height", sl, "u"), r("Lateral SA", PI * rad * sl, "u²"), r("Total SA", PI * rad * (rad + sl), "u²")];
    },
  ...
  {
    id: "frustum", name: "Frustum (Truncated Cone)",
    fields: [f("R", "Bottom Radius"), f("r", "Top Radius"), f("h", "Height")],
    calc: ({ R, r: tr, h }) => {
      const sl = Math.sqrt(h * h + (R - tr) ** 2);
      return [r("Volume", (PI * h / 3) * (R * R + R * tr + tr * tr)), r("Slant Height", sl, "u"), r("Lateral SA", PI * (R + tr) * sl, "u²"), r("Total SA", PI * (R * R + tr * tr + (R + tr) * sl), "u²")];
    },
    formula: "V = (πh/3)(R²+Rr+r²)",
  },
  {
    id: "prism", name: "Triangular Prism",
  ...
  {
    id: "pyramid", name: "Pyramid (Square Base)",
    fields: [f("a", "Base Side"), f("h", "Height")],
    calc: ({ a, h }) => {
      const sl = Math.sqrt(h * h + (a / 2) ** 2);
      return [r("Volume", (a * a * h) / 3), r("Slant Height", sl, "u"), r("Base Area", a * a, "u²"), r("Lateral SA", 2 * a * sl, "u²"), r("Total SA", a * a + 2 * a * sl, "u²")];
    },
    formula: "V = (1/3)a²h",
  },
  {
